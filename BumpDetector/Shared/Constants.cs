...
namespace BumpDetector.Shared
{
	public static class Constants
	{
        ...
        public static readonly int MINIMUM_DURATION_OF_MOTION = Device.OnPlatform(150, 150, 200);
		public static readonly double HIGH_SPEED_THRESHHOLD = Device.OnPlatform (150d, 180d, 200d);
